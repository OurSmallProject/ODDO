...
class ProfileAbout extends Component {
  render() {
    ...
    const favoriteSport = profile.favoriteSport.map((sport, index) => <Chip key={index} label={sport} />);
          ...
          <Card>
            <CardContent>
              ...
              <p>
                ...
                <Moment format="MM/DD/YYYY">{profile.date}</Moment>
              </p>
            </CardContent>
          </Card>
        </Grid>
